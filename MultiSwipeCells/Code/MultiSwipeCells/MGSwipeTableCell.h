...
{
    IBOutlet UILabel *startLoc_labl;
    IBOutlet UILabel *startLocLand_labl;
    IBOutlet UILabel *endLoc_labl;
    IBOutlet UILabel *endLocLand_labl;

    IBOutlet UIImageView *bikeImgView;
    IBOutlet UIImageView *userImgView;
    IBOutlet UILabel *name_labl;
    IBOutlet UILabel *AgoTime_labl;
    IBOutlet UILabel *Time_labl;

    IBOutlet UIButton *seat_Button;
    IBOutlet UILabel *price_labl;   
    IBOutlet UIView *View_bg;
    IBOutlet UIView *big_bg;
}
